...
import 'package:ProZigzagBus/agent_payout_controller_screen.dart';
                      ...
                      ListTile(
                        ...
                        subtitle:  Transform.translate(
                          ...
                          child: Padding(
                            ...
                            child: Text('$searchbus ${data?.wallet}',style:  TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold,fontSize: 20),),
                          ),
                        ),
                      ),
                      const Spacer(),
                                                    ...
                                                    child: Center(
                                                      child: ListTile(
                                                        ...
                                                        trailing: Radio(
                                                          ...
                                                          fillColor:  MaterialStatePropertyAll(notifier.theamcolorelight),
                                                          groupValue: true,
                                                          onChanged: (value) {
                                                            print(value);
                                                            setState(() {
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: ElevatedButton(
                            style: ButtonStyle(fixedSize: const MaterialStatePropertyAll(Size(120, 40)),elevation: const MaterialStatePropertyAll(0),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),backgroundColor:  MaterialStatePropertyAll(notifier.theamcolorelight)),
                            onPressed: () => {
